...
# حط ID حق ملف best.pt من Google Drive
...
def upload_video():
    ...
    temp_output_path = os.path.join(RESULT_FOLDER, "temp_" + os.path.splitext(filename)[0] + ".avi")
    final_output_filename = "out_" + os.path.splitext(filename)[0] + ".mp4"
    ...
    # تحويل الفيديو إلى mp4 متوافق مع المتصفح
    try:
        subprocess.run(
            [
                "ffmpeg",
    ...
    return render_template(
        ...
        result_video="/" + final_output_path
    )
